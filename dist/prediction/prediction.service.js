...
let PredictionService = PredictionService_1 = class PredictionService {
    ...
    async trainModel() {
        ...
        const trainingData = gradeRows.map((row) => {
            ...
            const coData = (_a = coFeatureMap[mlId]) !== null && _a !== void 0 ? _a : this._emptyCoFeatures();
            return {
                ...
                activities_below_60_pct: (_b = below60Map[mlId]) !== null && _b !== void 0 ? _b : 0,
        ...
        try {
            ...
            throw new common_1.InternalServerErrorException('Failed to train model. Is the Python API running?');
        }
    }
    async predictRisk(masterlistId) {
        ...
        if (gradeRow) {
            ...
            twp = (_a = partialMap[mlId]) !== null && _a !== void 0 ? _a : 0;
        ...
        const coData = (_b = (await this._computeCoFeatures([mlId]))[mlId]) !== null && _b !== void 0 ? _b : this._emptyCoFeatures();
        const below60 = (_c = (await this._getActivitiesBelow60Map([mlId]))[mlId]) !== null && _c !== void 0 ? _c : 0;
        ...
        const payload = {
            studid: String((_d = gradeRow === null || gradeRow === void 0 ? void 0 : gradeRow.studid) !== null && _d !== void 0 ? _d : mlId),
        ...
        try {
            ...
            return this._fallback((_e = gradeRow === null || gradeRow === void 0 ? void 0 : gradeRow.studid) !== null && _e !== void 0 ? _e : mlId, twp, finalGrade, remarks, coData.weak_cos, { is_partial: !gradeRow });
        }
    }
    async predictBatch(subjcode, section, sy, sem) {
        ...
        const payloads = eligibleStudents.map((student) => {
            ...
            const twp = fg
                ...
                : ((_b = partialTwpMap[mlId]) !== null && _b !== void 0 ? _b : 0);
            const cosWithData = (_c = coData._total_cos) !== null && _c !== void 0 ? _c : 0;
            return {
                ...
                min_co_score: coData.min_co_score,
                avg_co_score: coData.avg_co_score,
                activities_below_60_pct: (_d = below60Map[mlId]) !== null && _d !== void 0 ? _d : 0,
                weak_cos: coData.weak_cos,
                weak_co_details: coData.weak_co_details,
                current_grade: (_e = fg === null || fg === void 0 ? void 0 : fg.final_numerical_grade) !== null && _e !== void 0 ? _e : null,
                remarks: (_f = fg === null || fg === void 0 ? void 0 : fg.remarks) !== null && _f !== void 0 ? _f : null,
                is_partial: !fg,
    ...
    async getCoHeatmap(subjcode, section, sy, sem) {
        ...
        const studentsWithData = students.filter((s) => { var _a; return Object.keys((_a = coMap[Number(s.masterlist_id)]) !== null && _a !== void 0 ? _a : {}).length > 0; });
        ...
        try {
            ...
            this.logger.error('Python /heatmap failed', err === null || err === void 0 ? void 0 : err.message);
    ...
    async getTrajectory(subjcode, section, sy, sem) {
        ...
        if (!activityRows.length)
            return { error: 'No assessment scores found yet.' };
        const labelCounters = {};
        const actIdToLabel = {};
        ...
        for (const r of activityRows) {
            ...
            labelCounters[type] = ((_a = labelCounters[type]) !== null && _a !== void 0 ? _a : 0) + 1;
        ...
        for (const r of activityRows) {
            ...
            const pct = (!isNaN(score) && !isNaN(maxScore) && maxScore > 0)
                ...
                : null;
            actMap[mlId].push({ label: (_b = actIdToLabel[actId]) !== null && _b !== void 0 ? _b : `Act ${actId}`, co: (_c = r.co_code) !== null && _c !== void 0 ? _c : null, pct });
        }
        const studentsWithData = students.filter((s) => { var _a, _b; return ((_b = (_a = actMap[Number(s.masterlist_id)]) === null || _a === void 0 ? void 0 : _a.length) !== null && _b !== void 0 ? _b : 0) > 0; });
        if (!studentsWithData.length)
            return { error: 'No assessment scores found yet.' };
        const payload = studentsWithData.map((s) => ({
            studid: String(s.studid),
        ...
        try {
            ...
            this.logger.error('Python /trajectory failed', err === null || err === void 0 ? void 0 : err.message);
    ...
    async _computeCoFeatures(masterlistIds) {
        ...
        for (const mlId of masterlistIds) {
            ...
            const weakCoDetails = {};
            failed.forEach((c) => { var _a; weakCoDetails[c.co_code] = ((_a = typeGrouped[mlId]) === null || _a === void 0 ? void 0 : _a[c.co_code]) || []; });
            result[mlId] = {
    ...
    _fallback(studid, twp, grade, remarks, weakCos, extra = {}) {
        ...
        return Object.assign({ studid: String(studid), risk_level, risk_score, fail_probability: [10, 45, 85][risk_score], prob_safe: [80, 15, 15][risk_score], prob_warning: [15, 45, 15][risk_score], prob_critical: [5, 5, 80][risk_score], current_grade: grade, remarks, weak_cos: weakCos, weak_co_details: {}, source: 'fallback' }, extra);
    }
    _heatmapFallback(payload) {
        ...
        const studentsOut = payload.map((s) => {
            ...
            const avg = valid.length ? Math.round(valid.reduce((a, b) => { var _a; return a + ((_a = b.pct) !== null && _a !== void 0 ? _a : 0); }, 0) / valid.length * 10) / 10 : 0;
    ...
    _trajectoryFallback(payload) {
        ...
        const results = payload.map((student) => {
            ...
            for (const label of allLabels) {
                ...
                if ((a === null || a === void 0 ? void 0 : a.pct) !== null && (a === null || a === void 0 ? void 0 : a.pct) !== undefined) {
                    total += a.pct;
                    count++;
        ...
        results.sort((a, b) => { var _a, _b; return ((_a = order[a.trend]) !== null && _a !== void 0 ? _a : 1) - ((_b = order[b.trend]) !== null && _b !== void 0 ? _b : 1) || a.latest_avg - b.latest_avg; });
